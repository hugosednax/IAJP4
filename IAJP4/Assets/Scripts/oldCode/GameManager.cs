...
namespace Assets.Scripts.oldCode
{
    public class GameManager : MonoBehaviour
    {
                ...
                worldPhysical =
                    (GameObject)
                        Instantiate(worldPrefab,
                            worldPrefab.transform.position +
                            new Vector3((i/(numberOfWorlds/10))*230, (i%(numberOfWorlds/10))*230, 0)
        ...
        private Pair<List<GenesEncap>, List<GenesEncap>> StartNewGen()
        {
            ...
            List<Hunter> SortedHunterList = hunters.OrderByDescending(o => o.Energy).ToList();
                //can be changed to be better optimized
