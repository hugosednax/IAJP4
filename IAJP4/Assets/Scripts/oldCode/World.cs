...
namespace Assets.Scripts.oldCode
{
    ...
    {
        [SerializeField] protected int sizeX = 15;
        [SerializeField] protected int sizeY = 15;
        [SerializeField] protected float spacing = 4;
        [SerializeField] protected bool debug = true;
        [SerializeField] protected float tickTimer = 0.001f;
        ...
        void OnDrawGizmos()
        {
            ...
            for (int i = 0; i < sizeX*sizeY; i++)
            {
                ...
                Gizmos.DrawCube(
                    transform.position + new Vector3(i/sizeX*spacing, i%sizeX*spacing, 0) -
                    new Vector3(spacing*sizeX/2, spacing*sizeY/2, 0)
